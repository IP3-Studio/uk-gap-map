  ...
  return (
    <div className="prose">
      ...
      <p>
        ...
        anyone resourced to fill it today), and <strong>window</strong> (does a live date — a bill, a break
        clause, an election — make this year different from next). Each entry shows a one-line justification.
