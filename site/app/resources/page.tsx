  ...
  return (
    <div>
      ...
      <p className="disclosure">
        Entries marked <span className="badge logos">Logos</span> are part of the Logos ecosystem. They are rated
        by the same yardstick as everything else here — and, being pre-mainnet, mostly <em>early</em>. Check the
        maturity badge before you depend on anything.
      </p>
              ...
              {c.entries.map((e) => (
                <article key={e.name} className="resource-card">
                  <div className="meta">
                    ...
                    {e.logosEcosystem && <span className="badge logos">Logos</span>}
                  </div>
