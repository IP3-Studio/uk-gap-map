...
export default function AboutPage() {
  return (
    <div className="prose">
      ...
      <h2>Status: v0, deliberately crude</h2>
      <p>
        What you are looking at is the <strong>uncurated candidate inventory</strong>: 211 entries across 18
        domains produced by a structured research pass in July 2026. It has not yet been through editorial
        curation (deduplication, merging, ranking) or validation interviews with practitioners. Convergent
        shipped their v1.0 as “a crude map of an emerging space — not a prioritization”; this is cruder still,
        published in that spirit. Expect duplicates (the same missing fund can appear in several domains),
        uneven granularity, and entries that events have already overtaken.
      </p>
      ...
      <p>
        ...
        with every entry carrying its sources. The next phase is 30–50 practitioner interviews to kill, correct
        and re-rank entries, followed by an editorially curated v1.0 of roughly 100 canonical gaps.
      </p>
      <p>
