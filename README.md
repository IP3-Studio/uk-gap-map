...
to society. Built and maintained by **IP3 Studio**. Get involved, propose a gap or correct an entry via the repository's
issues.
...
└── app/ + components/ + data/     The website (Next.js, at the repo root)
...
| `additions.json` | Hand-curated gaps added after the research pass (decentralisation + Synthetic State lenses) |
...
- **Sourced, not asserted.** Every gap carries primary sources. Lens entries (decentralisation,
